                    ...
                    <div class="col-md-3 col-sm-6">
                       <article class="mind-features-item hover animated bounceInLeft animation-delay-8">
                           ...
                           <div class="item-content">
                               ...
                               <a href="forums/forums1.php" class="btn btn-success pull-right">View Forums</a>
                           </div>
                   ...
                   <div class="col-md-3 col-sm-6">
                       <article class="mind-features-item hover animated bounceInLeft animation-delay-3">
                           ...
                           <div class="item-content">
                               ...
                               <a href="blog/blog1.php" class="btn btn-success pull-right">View Blogs</a>
                               <a href="blog/add-blog.php" class="btn btn-success pull-left">Add Blogs</a>
                           </div>
                       </article> <!-- mind-features-item -->
                   </div>
                   ...
                   <div class="col-md-3 col-sm-6">
                       <article class="mind-features-item hover animated bounceInRight animation-delay-6">
                           ...
                           <div class="item-content">
                               ...
                               <a href="polling/polling1.php" class="btn btn-success pull-right">View Polling</a>
                           </div>
                       </article> <!-- mind-features-item -->
                   </div>
                   ...
                   <div class="col-md-3 col-sm-6">
                       <article class="mind-features-item hover animated bounceInRight animation-delay-10">
                           ...
                           <div class="item-content">
                               ...
                               <a href="achievements/achievements1.php" class="btn btn-success pull-right">View Achievements</a>
                           </div>
                       </article> <!-- mind-features-item -->
                   </div>
                </div>
                  ...
                  <div class="col-md-7">
                    <section class="home-post">
                        ...
                        <div class="row home-post-footer">
                            <div class="col-md-4">
                                <a href="latestblog1.php" class="btn btn-primary btn-block">Read more</a>
                            </div>
                        </div>
                    </section>
              </div>
