    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse navbar-mind-collapse">
            <ul id="menu-mainmenu" class="nav navbar-nav">
                ...
                <li id="menu-item-11" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-11">
                    <a title="Topic" href="leader-board1.php">Leader-Board</a>
                </li>
...
<header class="wrap-title">
    <div class="container">
        <h1 class="page-title">Leaderboard Results</h1>
    </div>
</header>
...
<div class="container">
    ...
    for ($nu = 1;$nu<=$rows;$nu++){
        ...
        global $database;
        $result = mysql_query('select u_name from user where u_rating='. $nu);
