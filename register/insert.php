...
//to see dat blank boxes dont go into database..
		...
		$sql = "insert into user(u_id, u_name, u_emailID, u_aemailID, u_password, u_isAdmin, u_photo, u_rating, u_securityQ, u_securityA)      values('$id','$name','$email','$aemail','$pwd','2','0','0','$sq','$sa')";
