...
<head>
    ...
    <link rel="alternate" type="application/rss+xml" title="Open Mind &raquo; FAQ Comments Feed" href="feed/index.html" />
...
<link rel='shortlink' href='http://wp.me/P4Cc4d-39' />

<!-- Jetpack Open Graph Tags -->
<meta property="og:type" content="article" />
<meta property="og:title" content="FAQ" />
<meta property="og:url" content="http://razonartificial.com/themes/openmind/wordpress/faq/" />
<meta property="og:description" content="Commodo occaecat officia consequat ullamco ut ex elit elit anim irure incididunt ut minim dolor ea consequat eu enim sunt commodo incididunt deserunt Ut laborum ullamco sint irure ullamco velit in ..." />
<meta property="article:published_time" content="2014-05-20T19:56:06+00:00" />
<meta property="article:modified_time" content="2014-05-20T19:56:06+00:00" />
            ...
            <div class="panel">
                ...
                <div id="collapseOne1" class="panel-collapse collapse in">
                    <div class="panel-body">
                        You need to sign up for taking part in online debate. You need da-iict id to sign up.
                    </div>
                </div>
            </div>
            <div class="panel">
                ...
                <div id="collapseTwo1" class="panel-collapse collapse">
                    <div class="panel-body">
                        Any da-iict student with da-iict id is eligible.
                    </div>
                </div>
            </div>
            <div class="panel">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion1" href="#collapseThree1">
                            3. If I am registered user, Can I submit topic for polling/forum?
                        </a>
                    </h4>
                </div>
                <div id="collapseThree1" class="panel-collapse collapse">
                    <div class="panel-body">
                        No, you can’t submit topic for polling/forum. You can add a request for the same.
                    </div>
                </div>
            </div>
            <div class="panel">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion1" href="#collapseFour1">
                            4. I've never debated before and don't have much experience in public speaking. Can I still join?
                        </a>
                    </h4>
                </div>
                <div id="collapseFour1" class="panel-collapse collapse">
                    <div class="panel-body">
                        Absolutely! Prior experience is not a prerequisite for doing well or learning to debate. Our training sessions and practice rounds will give you plenty of opportunities to practice and improve.
                    </div>
                </div>
            </div>
            <div class="panel">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion1" href="#collapseFive1">
                            5. What Topics Do You Debate?
                        </a>
                    </h4>
                </div>
                <div id="collapseFive1" class="panel-collapse collapse">
                    <div class="panel-body">
                        We choose topic from politics, social, sports etc. We also organize debate on current affairs.
                    </div>
                </div>
            </div>
            <div class="panel">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion1" href="#collapseSix1">
                            6. Is there any minimum requirements to take part in debate?
                        </a>
                    </h4>
                </div>
                <div id="collapseSix1" class="panel-collapse collapse">
                    <div class="panel-body">
                        There is no minimum competition requirement. 
                    </div>
                </div>
            </div>
            <div class="panel">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion1" href="#collapseSeven1">
                            7. Will Debate help me get into graduate and/or professional programs?
                        </a>
                    </h4>
                </div>
                <div id="collapseSeven1" class="panel-collapse collapse">
                    <div class="panel-body">
                        Yes. The critical thinking and communication skills one learns through debate are not only good for law school. It will help in improving your communication skill.
                    </div>
                </div>
            </div>
            <div class="panel">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion1" href="#collapseEight1">
                            8. Is there a grade requirement for participation in any debate?
                        </a>
                    </h4>
                </div>
                <div id="collapseEight1" class="panel-collapse collapse">
                    <div class="panel-body">
                        No. To participation in any debate, you must be registered user of daiict debate club.
                    </div>
                </div>
            </div>
		</div> <!-- panel-group -->
                ...
                <div class="col-md-4">
                    <h3 class="footer-widget-title">Sitemap</h3>
                        ...
                        <li id="menu-item-17" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-17">
                            <a href="faq1.php">Frequently Asked Questions</a>
                        </li>
...
<script type='text/javascript' src='../../../../../s0.wp.com/wp-content/js/devicepx-jetpack8aa1.js?ver=201512'></script>
	...
	st_go({v:'ext',j:'1:3.3',blog:'68208197',post:'195',tz:'0'});
	var load_cmc = function(){linktracker_init(68208197,195,2);};
...
<!-- Mirrored from razonartificial.com/themes/openmind/wordpress/faq/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Mar 2015 20:11:11 GMT -->
</html>
