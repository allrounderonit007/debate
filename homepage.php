...
<div class="col-md-5">
    ...
    <ul class="nav nav-tabs">
        <li class="active"><a href="#" data-toggle="tab">Top News</a></li><li><a href="#" data-toggle="tab">Society</a></li><li><a href="#" data-toggle="tab">Religion and Spirituality</a></li><li><a href="#" data-toggle="tab">Health</a></li>    
    </ul>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="society">             
            <div id="feeddiv">
                ...
                var feedurl="http://news.feedzilla.com/en_us/headlines/society.rss"
                var feedlimit=13
                var rssoutput="<b>Society:</b><br /><ul>"
    ...
    <!-- <div class="tab-content"> -->
        <div class="tab-pane active" id="religion">             
            <div id="feedreligion">
            </div>
                <script type="text/javascript">

                var feedcontainer=document.getElementById("feedreligion")
                var feedurl="http://news.feedzilla.com/en_us/headlines/religion-and-spirituality.rss"
                var feedlimit=13
                var rssoutput="<b>Religion and Spirituality:</b><br /><ul>"
    ...
    <!-- <div class="tab-content"> -->
        <div class="tab-pane active" id="health">             
            <div id="feeddiv">
                ...
                var feedcontainer=document.getElementById("feeddiv")
                var feedurl="http://news.feedzilla.com/en_us/headlines/health.rss"
                var feedlimit=13
                var rssoutput="<b>Health:</b><br /><ul>"
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="img-caption">
                                <img width="800" height="533" src="madhumita_mazumdar.jpg" class="attachment-, img-responsive wp-post-image" alt="w2" />                                                                <div class="caption">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="img-caption">
                                <img width="800" height="580" src="yognik.jpg" class="attachment-, img-responsive wp-post-image" alt="w1" />                                                                <div class="caption">
                                    <div class="caption-content">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="img-caption">
                                <img width="800" height="600" src="niyam.jpg" class="attachment-, img-responsive wp-post-image" alt="w6" />                                                                <div class="caption">
                                    <div class="caption-content">
